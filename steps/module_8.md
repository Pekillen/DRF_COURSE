...
OK
Destroying test database for alias 'default'...Pekillen123
```
...
> This retrieves the auth token for Pekillen

curl -X POST -F 'username=Pekillen' -F 'password=Pekillen123' http://api:8000/api-token-auth/

http post http://api:8000/api-token-auth/ username=Pekillen password=Pekillen123


> This will retrieve all items

curl -X GET -H 'Authorization: Token 658d00d12cd715d68eda998ed220ba9d12f6a519' http://api:8000/item/

http http://api:8000/item/ 'Authorization: Token 658d00d12cd715d68eda998ed220ba9d12f6a519'


> This will retreive a single item

curl -X GET -H 'Authorization: Token 658d00d12cd715d68eda998ed220ba9d12f6a519' http://api:8000/item/**your_item_uuid**/

http http://api:8000/item/**your_item_uuid**/ 'Authorization: Token 658d00d12cd715d68eda998ed220ba9d12f6a519' 

> This retrieve all orders

curl -X GET -H 'Authorization: Token 658d00d12cd715d68eda998ed220ba9d12f6a519' http://api:8000/order/

http http://api:8000/order/ 'Authorization: Token 658d00d12cd715d68eda998ed220ba9d12f6a519'

> This will place an order for item id = **your_item_uuid** quantity = 1

curl -X POST -H 'Content-Type: application/json' -H 'Authorization: Token 658d00d12cd715d68eda998ed220ba9d12f6a519' -d '{"item": "**your_item_uuid**", "quantity": "1"}' http://api:8000/order/

http http://api:8000/order/ 'Authorization: Token 658d00d12cd715d68eda998ed220ba9d12f6a519' item="**your_item_uuid**" quantity="1"


> This get order id = **your_order_uuid**

curl -X GET -H 'Authorization: Token 658d00d12cd715d68eda998ed220ba9d12f6a519' http://api:8000/order/**your_order_uuid**/

http http://api:8000/order/**your_order_uuid**/ 'Authorization: Token 658d00d12cd715d68eda998ed220ba9d12f6a519'
